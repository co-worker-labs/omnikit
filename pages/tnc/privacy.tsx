    ...
    return (
        <Layout footerPosition='none'>
            <section className='container pt-3 text-break'>
                ...
                <div className='mt-4'>
                    <h3>Privacy Statement for W3tools</h3>
                    <div>
                        <p>
                            This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from w3tools.online (the &quot;Site&quot;).
                        </p>
                    </div>
                </div>
                <div className='mt-4'>
                ...
                <div className='mt-4'>
                    ...
                    <div>
                        ...
                        <p>
                            We fund our site by showing adverts as you browse our site. These adverts are usually managed by a partner specializing in providing adverts for multiple sites. Invariably these partners collect anonymous data about the websites you visits so they can personalize the adverts to you, ensure that you don&lsquo;t see the same adverts too frequently and ultimately report to advertisers on which adverts are working. We use a third-party to provide monetization technologies for our site. You can review their privacy and cookie policy here.
                        </p>
                        <p>
                ...
                <div className='mt-4'>
                    ...
                    <div>
                        <p>
                            As described above, we use your Personal Information to provide you with targeted advertisements or marketing communications we believe may be of interest to you. For more information about how targeted advertising works, you can visit the Network Advertising Initiative&lsquo;s (&quot;NAI&quot;) educational page at http://www.networkadvertising.org/understanding-online-advertising/how-does-it-work.
                        </p>
                        <p>
                        ...
                        <p>
                            Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance&lsquo;s opt-out portal at: http://optout.aboutads.info/.
                        </p>
                        <p>
                        ...
                        <p>
                            <span className='strong'>Note:</span>Opting out will not disable ads, they will just no longer be tailored to you.
                        </p>
                    </div>
                </div>
                <div className='mt-4'>
                    <h3>Do not track</h3>
                    <div>
                        Please note that we do not alter our Site&lsquo;s data collection and use practices when we see a Do Not Track signal from your browser.
                    </div>
                </div>
                ...
                <div className='mt-4'>
                    <h3>Using Google Drive in our Tryit Editor</h3>
                    <div>
                        <p>
                        ...
                        <p>
                            W3tools does not keep for ourselves, or share this information with third parties.
                        </p>
                    </div>
                </div>
                ...
                <div className='mt-4'>
                    ...
                    <div>
                        <p>
                            W3tools contains links to other sites. We are not responsible for the privacy practices or the content of such Web sites. This privacy document applies only to W3tools.
                        </p>
                    </div>
                </div>
                ...
                <div className='mt-4'>
                    ...
                    <div>
                        <p>
                            For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at help@w3tools.online
                        </p>
                    </div>
                </div>
            </section>
